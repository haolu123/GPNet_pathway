    ...
    for sample_size in sample_size_list:
        ...
        for loop_i in range(20):
            ...
            for idx_gene_list in range(len(gene_list)):
                ...
                fdr.append(p_value)
                if idx_gene_list in pathway_list:
                    p_value_all[SNR][sample_size]['diff'].append(p_value)
                else:
                    p_value_all[SNR][sample_size]['same'].append(p_value)
#%%
with open('./results/p_value_real_diff_vs_same.pkl', 'wb') as f:
    pickle.dump(p_value_all, f)

#%%
sample_size_list = [200,250]
for sample_size in sample_size_list:
...
# # %%
# with open('./results/type_I_error_avg_list_snr_cls_real_v2.pkl', 'wb') as f:
#     pickle.dump(type_I_error_avg_list_snr, f)
# with open('./results/power_avg_list_snr_cls_real_v2.pkl', 'wb') as f:
