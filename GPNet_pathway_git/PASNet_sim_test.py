...
class PASNet(nn.Module):
	def __init__(self, In_Nodes, Out_Nodes, Pathway_Nodes=150, Hidden_Nodes=50, ):
...
# %%
print(f'PASNet_sim: type_I_error_avg_list_snr: {type_I_error_avg_list_snr}')
print(f'PASNet_sim: power_avg_list_snr: {power_avg_list_snr}')
with open('./results/type_I_error_avg_list_snr_sim_PASNet.pkl', 'wb') as f:
    pickle.dump(type_I_error_avg_list_snr, f)
with open('./results/power_avg_list_snr_sim_PASNet.pkl', 'wb') as f:
